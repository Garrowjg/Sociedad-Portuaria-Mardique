...
(function() {
    ...
    const NODES = [
        { lon: -75.5, lat: 10.4, hub: true,  labelDir: 'above', label: 'Sociedad Portuaria Mardique', desc: 'Puerto multipropósito privado con conexión directa al interior del país. Operaciones 24/7.', image: 'https://spmardique.com/wp-content/uploads/2022/06/2.jpg' },
        { lon: -118.3, lat: 33.7, hub: false, labelDir: 'above', label: 'Los Ángeles', desc: 'El puerto más activo de EE.UU. Principal puerta de entrada para bienes desde Asia.', image: 'https://portalportuario.cl/wp-content/uploads/2022/04/Puertos-de-Los-Angeles.jpg' },
        { lon: -74.0, lat: 40.7, hub: false, labelDir: 'above', label: 'Nueva York', desc: 'Segundo puerto más importante de la costa este de EE.UU. Puerta a los mercados del noreste.', image: 'https://kokargo.com/wp-content/uploads/2024/09/NewYork-scaled.webp' },
        { lon: -95.3, lat: 29.8, hub: false, labelDir: 'below', label: 'Houston', desc: 'Líder en carga de hidrocarburos y productos petroquímicos en América del Norte.', image: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh9BbwXgQpiyDgOC2Pq_zCm9maZ98Dy5oiDjayngJZi-tT0Unudeu7vrXc-SRYDM6Nv3FZPlme6zg4m_f5ufN5dgQZq_wvUcli9wGY0raiEqac2X3KvEw1H-6HNTf3LcwfbAtTxnlLpWasuwIz6VEY6cMmXx7fyBqGoTUW7dcuin1cuSfIU-b5xUfiVIMTg/s666/pto%20houston.png' },
        { lon: -79.9, lat: 9.0,  hub: false, labelDir: 'below', label: 'Canal de Panamá', desc: 'Corredor interoceánico estratégico. Más de 14.000 buques transitan cada año.', image: 'https://pancanal.com/wp-content/uploads/2023/08/Canal-Connection-Agost-2023-1024x576.jpg' },
        { lon: -46.3, lat: -23.9, hub: false, labelDir: 'right', label: 'Santos', desc: 'El puerto más grande de América Latina. Maneja más del 30% del comercio exterior brasileño.', image: 'https://i0.wp.com/www.comexlatam.com/wp-content/uploads/2026/02/Puerto-Santos-Mundo-maritimo.jpeg?fit=2046%2C1530&ssl=1' },
        { lon: -77.1, lat: -12.1, hub: false, labelDir: 'left',  label: 'Callao', desc: 'Principal puerto del Pacífico sudamericano. Puerta de la minería y agroexportación peruana.', image: 'https://lacamara.pe/wp-content/uploads/2020/09/idexcam-2.jpg' },
        { lon: -58.4, lat: -34.6, hub: false, labelDir: 'below', label: 'Buenos Aires', desc: 'Principal puerto de Argentina en el Río de la Plata. Clave para granos y contenedores.', image: 'https://www.lanacion.com.ar/resizer/v2/vista-aerea-del-puerto-de-buenos-MCCGYZMRAJCMROINA2H7CUADLA.jpg?auth=519405ff6966124e71dcf40830a1dab1d60263408a9f4386c8966833f05af1be&width=768&quality=70&smart=false' },
        { lon: 4.5,  lat: 51.9, hub: false, labelDir: 'above', label: 'Róterdam', desc: 'El puerto más grande de Europa. Conecta a Cartagena con todos los mercados europeos.', image: 'https://www.sglusa.com/wp-content/uploads/2022/09/thialf-heerema-locatie-calandkanaal-havenbedrijf-rotterdam-kees-torn-juni-2020.jpeg' },
        { lon: 2.2,  lat: 41.4, hub: false, labelDir: 'above', label: 'Barcelona', desc: 'Principal puerta de entrada de mercancías de América Latina a la Europa mediterránea.', image: 'https://www.portdebarcelona.cat/sites/default/files/styles/wide/public/content/image/2024/05/02/98/20240429_portes_obertes.jpg' },
        { lon: 55.3, lat: 25.1, hub: false, labelDir: 'above', label: 'Jebel Ali', desc: 'El mayor puerto del Medio Oriente. Uno de los 10 más activos del mundo.', image: 'https://kokargo.com/wp-content/uploads/2024/10/port43.webp' },
        { lon: 32.3, lat: 29.9, hub: false, labelDir: 'right', label: 'Port Said', desc: 'Entrada al Canal de Suez. Uno de los puntos de tránsito marítimo más importantes del mundo.', image: 'https://www.revigorate.com/images/corniche-port-said.jpg' },
        { lon: 18.3, lat: -33.9, hub: false, labelDir: 'below', label: 'Ciudad del Cabo', desc: 'Punto estratégico entre América del Sur y el océano Índico.', image: 'https://cdn.portalfruticola.com/2025/03/puerto-Ciudad-del-Cabo-Sudafrica.jpg' },
        { lon: 121.5, lat: 31.2, hub: false, labelDir: 'above', label: 'Shanghái', desc: 'El puerto más grande del mundo por volumen de contenedores. 49M TEU / año.', image: 'https://kokargo.com/wp-content/uploads/2024/09/Shanghai.webp' },
        { lon: 103.9, lat: 1.3,  hub: false, labelDir: 'below', label: 'Singapur', desc: 'Segundo puerto más grande del mundo. Mayor hub de transbordo de Asia.', image: 'https://www.mundomaritimo.cl/noticias/get_image/52634/798' },
        { lon: 129.1, lat: 35.1, hub: false, labelDir: 'above', label: 'Busan', desc: 'Quinto puerto más transitado del mundo. 21.7M TEU / año.', image: 'https://www.cargoflores.com/wp-content/uploads/2021/06/Busan-Port-Photo-Bloomberg.jpeg' },
        { lon: 151.2, lat: -33.9, hub: false, labelDir: 'right', label: 'Sídney', desc: 'Principal puerto de Australia para contenedores.', image: 'https://noticiaspuertosantamarta.com/wp-content/uploads/2023/02/4-700x400.jpg' }
    ];
